...
async function main() {
  const corrections = [
    { ticker: 'GJF', sector: 'Finance', note: 'Gjensidige Forsikring - Insurance company' },
    { ticker: 'NONG', sector: 'Finance', note: 'SpareBank 1 Nord-Norge - Bank' },
    { ticker: 'RECSI', sector: 'Materials', note: 'REC Silicon - Silicon production' },
  ];

  console.log('Fixing sector classifications (round 2)...\n');
